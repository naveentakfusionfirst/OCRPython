...
def upload_file():
    ...
    for file in files:
        if file and allowed_file(file.filename):
            ...
            pytesseract.pytesseract.tesseract_cmd = r"C:\Users\hemant.bhadaktiya\AppData\Local\Programs\Tesseract-OCR\tesseract.exe"    
            soucecontent = []
...
#if __name__ == "__main__":
    #app.run(threaded=True,port=9090,host="0.0.0.0")